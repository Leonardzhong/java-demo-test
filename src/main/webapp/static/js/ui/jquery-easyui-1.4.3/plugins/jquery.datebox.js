...
(function($){
    ...
    $.fn.datebox.defaults=$.extend({},$.fn.combo.defaults,{panelWidth:180,panelHeight:"auto",sharedCalendar:null,keyHandler:{up:function(e){
        ...
        _16(this,q);
    }},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_30){
        ...
        return $(_34).datebox("options").cleanText;
    },handler:function(_35){
        $(_35).combo('setValue', '').combo('setText', '');
