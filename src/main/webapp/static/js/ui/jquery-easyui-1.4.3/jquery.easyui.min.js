...
_a37(this,q);
}},currentText:"Today",cleanText:"Clean",closeText:"Close",okText:"Ok",buttons:[{text:function(_a4c){
...
$(this).closest("div.combo-panel").panel("close");
    ...
    return $(_a4g).datebox("options").cleanText;
},handler:function(_a4h){
    $(_a4h).combo('setValue', '').combo('setText', '');
}}],formatter:function(date){
